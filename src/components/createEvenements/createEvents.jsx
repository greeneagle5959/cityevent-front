        ...
        <div className="row ">
            <div className="col-lg-6 mx-auto">
                ...
                <form onSubmit={formCreateEvent}>
                    ...
                    <input type="text" value={address} onChange={(e) => setAdresse(e.target.value)} className="form-control" />
                    <label>Numero de telephone</label>
                    <input type="numbre" value={price} onChange={(e) => setPrice(e.target.value)} className="form-control" />
                    <label>Nombre de place</label>
                    <input type="text" value={seats} onChange={(e) => setAdresse(e.target.value)} className="form-control" />
